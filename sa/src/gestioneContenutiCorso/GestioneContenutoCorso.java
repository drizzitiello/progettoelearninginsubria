...
public class GestioneContenutoCorso {
	...
	public void createFolder(String name, String path, int codSezione, String pubblica, String codRisorsa, String descr, String tipo) throws ClassNotFoundException, SQLException {
		socket=SocketDb.getInstanceDb();
